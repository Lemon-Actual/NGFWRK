...
###Script for once the VPN is connected###

###Configure SSH Paramaters###
ssh = paramiko.SSHClient()
###Accept missing key policy to auto accept###
ssh.set_missing_host_key_policy(paramiko.AutoAddPolicy())
###define Firewall IP or hostname, username and password for connection###
...
###This specifically is for modifying a Fortigate on 6.4.2 Firmware and firewall rule 2###
...
channel.send('set name "VPN to Inside"\n')
time.sleep(1)
...
###Call IPERF3###
    ...
    client2.duration = 5
###IPERF3 Server hostname or address###
    client2.server_hostname = '192.168.1.10'
###IPERF3 Server Port###    
    client2.port = 4444
###IPERF3 test protocol###
...
###Call IPERF3###
    ...
    client3.duration = 5
###IPERF3 Server hostname or address###
    client3.server_hostname = '192.168.1.10'
###IPERF3 Server Port###    
    client3.port = 4444
###IPERF3 test protocol###
...
###File to write perfomance output to###
with open('FortiVPNProxybaseline.txt', 'w' ) as f:
    sys.stdout = f
...
###Call IPERF3###
    ...
    client2p.duration = 5
###IPERF3 Server hostname or address###
    client2p.server_hostname = '192.168.1.10'
###IPERF3 Server Port###    
    client2p.port = 4444
###IPERF3 test protocol###
...
###File to write perfomance output to###
with open('FortiVPNbaselinePAV.txt', 'w' ) as f:
    sys.stdout = f
...
###Call IPERF3###
    ...
    clientAV.duration = 5
###IPERF3 Server hostname or address###
    clientAV.server_hostname = '192.168.1.10'
###IPERF3 Server Port###    
    clientAV.port = 4444
###IPERF3 test protocol###
...
###IPERF3 Server hostname or address###
    clientAV2.server_hostname = '192.168.1.10'
###IPERF3 Server Port###    
    clientAV2.port = 4444
###IPERF3 test protocol###
...
###IPERF3 Server hostname or address###
    clientAV3.server_hostname = '192.168.1.10'
###IPERF3 Server Port###    
    clientAV3.port = 4444
###IPERF3 test protocol###
...
###File to write perfomance output to###
with open('FortiVPNbaselinePAVIPS.txt', 'w' ) as f:
    sys.stdout = f
...
###IPERF3 Server hostname or address###
    clientPAVIPS.server_hostname = '192.168.1.10'
###IPERF3 Server Port###    
...
###IPERF3 Server hostname or address###
    clientPAVIPS2.server_hostname = '192.168.1.10'
###IPERF3 Server Port###    
...
###IPERF3 Server hostname or address###
    clientPAVIPS3.server_hostname = '192.168.1.10'
###IPERF3 Server Port###    
...
###File to write perfomance output to###
with open('FortiVPNbaselinePAVIPSC.txt', 'w' ) as f:
    sys.stdout = f
...
###IPERF3 Server hostname or address###
    clientPAVIPSC.server_hostname = '192.168.1.10'
###IPERF3 Server Port###    
...
###IPERF3 Server hostname or address###
    clientPAVIPSC2.server_hostname = '192.168.1.10'
###IPERF3 Server Port###    
...
###IPERF3 Server hostname or address###
    clientPAVIPSC3.server_hostname = '192.168.1.10'
###IPERF3 Server Port###    
